...
export function buildSsoProvidersCollection({
  ...
  const ssoProviderSlug = getSchemaCollectionSlug(
    resolvedSchemas,
  ...
  if (
    typeof pluginOptions.pluginCollectionOverrides?.ssoProviders === "function"
  ) {
    ssoProviderCollection =
      pluginOptions.pluginCollectionOverrides.ssoProviders({
