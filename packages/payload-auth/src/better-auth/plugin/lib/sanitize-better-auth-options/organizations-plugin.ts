...
export function configureOrganizationPlugin(plugin: any, resolvedSchemas: BetterAuthSchemas): void {
  ...
  set(
    ...
    getSchemaFieldName(resolvedSchemas, baModelKey.invitation, baModelFieldKeys.invitation.organizationId)
  )
  set(
    plugin,
  ...
  set(
    ...
    getSchemaFieldName(resolvedSchemas, baModelKey.invitation, baModelFieldKeys.invitation.inviterId)
  )
  set(
    plugin,
  ...
  set(
    ...
    getSchemaFieldName(resolvedSchemas, baModelKey.session, baModelFieldKeys.session.activeOrganizationId)
  )
  set(
    plugin,
