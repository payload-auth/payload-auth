...
<<<<<<< HEAD:packages/better-auth/src/plugin/payload/components/admin-buttons.tsx
...
>>>>>>> chore/restructure-demo-templates:packages/payload-auth/src/better-auth/plugin/payload/components/admin-buttons.tsx
import './styles.css'
