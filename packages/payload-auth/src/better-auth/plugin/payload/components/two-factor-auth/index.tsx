...
export function TwoFactorAuth({ baseURL, basePath }: TwoFactorAuthProps) {
  ...
  const [formState, setFormState] = useState<
    "enable" | "verify" | "backupCodes" | "disable"
  >("enable");
  ...
  const EnableForm = () => {
    ...
    return (
      ...
      >
        ...
        <form.AppForm
          children={<form.Submit label="Enable" loadingLabel="Enabling" />}
        />
      </Form>
    );
  };
  ...
  const VerifyForm = () => {
    ...
    return (
      ...
      >
        ...
        <form.AppForm
          children={<form.Submit label="Verify" loadingLabel="Verifying" />}
        />
      </Form>
    );
  };
  ...
  const DisableForm = () => {
    ...
    return (
      ...
      >
        ...
        <form.AppForm
          children={
            <form.Submit label="Disable Two‑Factor" loadingLabel="Disabling" />
          }
        />
      </Form>
    );
            ...
            {formState === "verify" && (
              <>
                ...
                <div className="two-factor-auth-modal__verify-block">
                  <p>
                    Scan the QR code with your authenticator app or copy the
                    URI.
                  </p>
