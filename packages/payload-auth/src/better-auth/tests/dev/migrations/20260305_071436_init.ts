...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TABLE "organization_role" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"organization_id_id" integer NOT NULL,
  ...
  ALTER TABLE "sessions" ADD CONSTRAINT "sessions_active_team_id_teams_id_fk" FOREIGN KEY ("active_team_id") REFERENCES "public"."teams"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "organization_role" ADD CONSTRAINT "organization_role_organization_id_id_organizations_id_fk" FOREIGN KEY ("organization_id_id") REFERENCES "public"."organizations"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "payload_locked_documents_rels" ADD CONSTRAINT "payload_locked_documents_rels_organization_role_fk" FOREIGN KEY ("organization_role_id") REFERENCES "public"."organization_role"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE INDEX "sessions_active_team_idx" ON "sessions" USING btree ("active_team_id");
  ...
  CREATE INDEX "organization_role_organization_id_idx" ON "organization_role" USING btree ("organization_id_id");
  CREATE INDEX "organization_role_permission_idx" ON "organization_role" USING btree ("permission");
  ...
  CREATE INDEX "payload_locked_documents_rels_organization_role_id_idx" ON "payload_locked_documents_rels" USING btree ("organization_role_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "organization_role" CASCADE;
