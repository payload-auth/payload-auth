...
import type {
  ...
  TPlugins,
} from "../../better-auth-plugin/src/types";
...
export * from "../../better-auth-plugin/src/types";
...
export function payloadBetterAuth(
  ...
  return (config: Config): Config => {
    ...
    config.onInit = async (payload) => {
      ...
      const auth = initBetterAuth<
        NonNullable<typeof sanitzedBetterAuthOptions.plugins>
      >({
        payload,
        options: {
