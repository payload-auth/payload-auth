...
export default function DashboardPage() {
  ...
  return (
    <main className="bg-muted flex min-h-screen w-full items-center justify-center">
      <div className="bg-background container mx-auto my-12 max-w-md space-y-8 rounded-lg p-8 shadow-lg">
        <div className="space-y-1 text-center">
          <h1 className="text-3xl font-bold tracking-tight">Better Auth x Payload CMS</h1>
          <p className="text-muted-foreground">
            Explore authentication features and seamless org/team switching—built with <span className="font-semibold">better-auth</span>.
          </p>
        </div>
