...
export const Tabs = ({
  ...
  return (
    <>
      <div
        className={cn(
          "flex flex-row items-center justify-start mt-0 relative overflow-auto sm:overflow-visible no-visible-scrollbar border-x w-full border-t max-w-max bg-opacity-0",
          containerClassName
        )}
      >
